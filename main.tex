...
\begin{equation}\label{eq:D2-alt}
...
\subsection{Major-arc evaluation for $B(\alpha)$}
...
\subsection{Transferring the main term to $S(\alpha)$}
...
\subsection{Sieve weight $\beta$ and properties}
...
\subsection{Kuznetsov at level $q$ (uniform form) and a $\Delta$-second-moment lemma}
