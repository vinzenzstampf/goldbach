...
\begin{proof}
	...
	Summing the Type~I/II/III contributions over all dyadic blocks and invoking
	Theorem~\ref{thm:typeII} (Type~II), Proposition~\ref{prop:typeIII} (Type~III),
	and Theorem~\ref{thm:BVP2M} (Type~I), we obtain \eqref{thm:minor-L2}. \\
