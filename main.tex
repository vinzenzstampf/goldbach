...
\begin{proof}
	...
	Kuznetsov formula on $\Gamma_0(q)$ from Lemma~\ref{lem:kuznetsov-uniform-kernel} to the
	...
	Lemma~\ref{lem:kuznetsov-uniform-kernel}, the Kloosterman modulus is restricted to
